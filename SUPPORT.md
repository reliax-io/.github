...
Reliax is a small team. Issues are usually triaged within a few working days.
Reproduction failures and security reports are looked at first.

There is no paid support tier for the public repositories. Commercial
customers have separate channels.

## What we will not do

- Debug your model. We assess models; we do not tune them.
- Advise on whether a particular deployment satisfies a particular regulation.
  We provide the evidence; your compliance function decides what it means.
- Quietly change a published result. Corrections are published as corrections.
